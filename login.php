         ...
         <div class="row">
            <div class="login">
               <div class="stellar-login">
                   <img  id="logo" src="https://amerifirst.online/onstellar/themes/wowonder/img/day.png" width="130" src="" alt="">
                  <h3>Sorry, you can't sign up yet</h3>
                  <p>You're not old enough to use onstellar yet</p>
                  <ul>
                     <li><button>Get help</button></li>
                     <li><button class="log-in"><a  style="color:white;text-decoration:none;" href="https://amerifirst.online/onstellar/">Log in</a></button></li>
                  </ul>
               </div>
            </div>
         </div>
