...
$pages = array(
    ...
    'add-language',
    'edit-lang',
    'manage-users',		'manage-categories',		'edit-new-cat',
    'manage-stories',
    ...
    'manage-apps',
    'auto-friend',
    'fake-users',	'edit-new-cat',	'add-new-cat',
);
$mod_pages = array('dashboard','manage-categories', 'post-settings', 'manage-stickers', 'manage-gifts', 'manage-users', 'online-users', 'manage-stories', 'manage-pages', 'manage-groups', 'manage-posts', 'manage-articles', 'manage-events', 'manage-forum-threads', 'manage-forum-messages', 'manage-movies', 'manage-games', 'add-new-game', 'manage-user-ads', 'manage-reports', 'manage-third-psites', 'edit-movie','edit-new-cat','add-new-cat');
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li <?php echo ($page == 'general-settings' ||  $page == 'edit-new-cat' ||  $page == 'add-new-cat' || $page == 'post-settings' || $page == 'site-settings' || $page == 'email-settings' || $page == 'social-login' || $page == 'site-features' || $page == 'amazon-settings' ||  $page == 'video-settings' || $page == 'payment-settings') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            ...
                            </li>														  <li <?php echo ($page == 'manage-categories') ? 'class="active"' : ''; ?>>                                <a href="<?php echo Wo_LoadAdminLinkSettings('manage-categories'); ?>">Categories</a>                            </li>
                        </ul>
                    </li>
                    <?php } ?>
                    <?php if ($is_admin == true) { ?>
